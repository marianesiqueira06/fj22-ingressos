...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes (){
		this.rogueOne = new Filme ( "rougue one", Duration.ofMillis(120), "SCI-FI", BigDecimal.ONE);
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesNaMesmaHora(){
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaNovaSessaoExistente(){
